...
3. **Pivoting**: Horizontal replication across the fleet via Pass-the-Hash (PtH) exploiting identical RID 500 local accounts (absence of Windows LAPS).
